       ...
       <h2 class="text-4xl font-bold mb-2">{{ $post->title }}</h2>
            <div class="flex items-center justify-between">
                <div class="flex items-center text-gray-600 text-sm mb-4 gap-1">
                    <img src="https://pc.net/img/terms/avatar.svg" alt="{{ $post->user->name }}" class="w-10 h-10 rounded-full ">
        ...
        <a href="{{ route('blog.main') }}" class="mt-6 inline-block bg-blue-500 text-white px-2 py-2 rounded">
            Back to All Posts
        </a>
    </div>
</div>
